...
- **Reset demo** clears the demo database and all `demo:fss:*` localStorage keys,
  then starts the five-prompt session again.
- **Start for real** clears the same demo-only data and opens `/`. It never copies
  sample work into the real workspace.
