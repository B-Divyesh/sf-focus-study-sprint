...
Audited from the rendered `/` page on 2026-08-30. Hyphenated terms and numbers count
...
| Copy | Words | Result |
| --- | ---: | --- |
| Run a short active-recall study session. | 6 | Pass |
...
| Core study and JSON backup are free. | 8 | Pass |
...
| Short active-recall sessions for students and self-learners. | 7 | Pass |
| Original artwork generated for this product. | 6 | Pass |
...
| Begin this sprint | 3 | Start action |
| Finish one study sprint in three steps | 7 | Process heading |
| Your study material stays local | 6 | Privacy heading |
| Bring material you trust | 4 | Product-limit heading |
| Keep reusable prompt sets for $12 | 6 | Price heading |
| Buy Contour once for $12 | 5 | Purchase action |

The headline is six words. The next sentence names students and self-learners. The
