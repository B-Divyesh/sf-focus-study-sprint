...
function shell(content: string): string {
  ...
  return `
    ...
    <footer>
      ...
      <div><a href="${routeFor('about')}" data-nav="about">About</a><a href="${demoExitHref('/privacy/')}" ${DEMO_MODE ? 'data-demo-exit' : ''}>Privacy</a><a href="${demoExitHref('/terms/')}" ${DEMO_MODE ? 'data-demo-exit' : ''}>Terms</a><span>Built by Param Factory</span><span>v1.1.6 · repair-8</span></div>
    </footer>
